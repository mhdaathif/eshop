            ...
            <div class="col-md-6">
                <div class="form-container">
                    <form autocomplete="off" action="checkout-charge.php" method="POST">
                        ...
                        <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="pk_test_51LZov4AV0Z8Tapioq6xCQJV0QQdBtqhaYydx3qH2A1qwLGZexQiq9JlOWkI0WHaI8sGJqOApeEQoAkmNHpoEeiHK00kIZl7qGw" data-amount=<?php echo str_replace(",", "", $product_data["price"]) * 100 ?> data-name="<?php echo $product_data["title"] ?>" data-description="<?php echo $product_data["title"] ?>" data-currency="LKR" data-locale="auto">
                        </script>
                    </form>
                </div>
            </div>
