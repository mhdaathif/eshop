    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- <div class="col-12 bg-light text-center">
                <span class="fs-1 fw-bold text-black-50 d-block" style="margin-top: 200px;margin-bottom: 200px;">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="row g-2">
                                    ...
                                    <div class="card mx-0 my-3" style="max-width: 540px;">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <img src="resources/mobile_images/iphone12_3.jpg" class="img-fluid rounded-start">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title">iPhone 12</h5>
                                                    <p class="card-text"><b>Seller :</b> Mohamed Jasir</p>
                            ...
                            <div class="col-12 col-lg-2 bg-light text-center text-lg-end">
                                <label class="form-label fs-5 fw-bold px-3 py-5">2021-10-16 23:06:47</label>
                            </div>
