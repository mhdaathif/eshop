        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-6 col-lg-1 bg-white"></div>
                </div>
            </div>
                ...
                <div class="col-12 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 bg-light py-2 d-none d-lg-block" onclick="viewProductModal('<?php echo $product_data['id']; ?>');">
                            <img src="<?php echo $image_data["code"]; ?>" style="height: 60px; margin-left: 80px;" />
                        </div>
                        <div class="col-3 col-lg-2 bg-primary py-2">
                        ...
                        <div class="col-2 bg-primary py-2 d-none d-lg-block">
                            <span class="fs-6 fw-bold text-light"><?php echo $product_data["qty"]; ?></span>
                        </div>
                        <div class="col-2 bg-light py-2 d-none d-lg-block">
                            <span class="fs-6 fw-bold text-dark">
                                <?php $row = $product_data["datetime_added"];
                                $splited = explode(" ", $row);
                                echo $splited[0]; ?>
                            </span>
                        </div>
